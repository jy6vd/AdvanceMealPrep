...
class Recipes: NSManagedObject{
    ...
    @NSManaged public var savedDay: String?
    
    var ingredients: [Ingredients]?{
        return self.rawIngredients?.array as? [Ingredients]
    }
    
    convenience init?(name: String?,descriptions: String?, meal: String?, serving: String?, direction: String?, picture: String?, savedDay: String?){
